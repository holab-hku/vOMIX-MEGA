...
class PreProcessingModule(Module):
    ...
    name = "preprocess"
    def __init__(self, decontam_host=False, hasOptions=False, dwnld_params=None, pigz_paramss=None, fastp_params=None, hostile_params=None, hostile_aligner=None, hostile_aligner_params=None, hostile_index_name=None, dwnld_only=False):
...
class ViralBenchmarkModule(Module): 
        ...
        def __init__(self, hasOptions=False, PhaBox2_db=None, genomad_db=None, virsorter2_db=None, vibrant_db=None, contig_min_len=0, genomad_min_len=1000, genomad_params=None, genomad_cutoff=0.7, genomad_cutoff_s=0, checkv_original=False, checkv_params=None, clustering_fast=True, cdhit_params=None, vOTU_ani=95, vOTU_targetcov=85, vOTU_querycov=0, dvf_min_len=1500, phamer_min_len=2000, dvf_params=None, phamer_params=None, virsorter2_params=None, vf_params=None, vibrant_params=None, seeker_params=None, ppr_params=None, dvf_cutoff=0.7, dvf_pval=0.05, phamer_pred=None, phamer_cutoff=0, vf_cutoff=0, virsorter2_cutoff=0, seeker_cutoff=0, ppr_cutoff=0, vibrant_cutoff=0, phabox2_db_name=None, phabox2_db_baselink=None):
        self.hasOptions = hasOptions
...
class ViralTaxonomyModule(Module):
    ...
    name = "viral-taxonomy"
    def __init__(self, hasOptions=False, PhaBox2_db=None, phabox2_db_name=None, phabox2_db_baselink=None, phagcn_min_len=1500, phagcn_params=None, diamond_params=None, genomad_db=None, genomad_tax_params=None):
        self.hasOptions = hasOptions
        self.PhaBox2_db = PhaBox2_db
        self.phabox2_db_name = phabox2_db_name
        self.phabox2_db_baselink = phabox2_db_baselink
...
class ViralHostModule(Module):
    ...
    name = "viral-host"
    def __init__(self, hasOptions=False, PhaBox2_db=None, phabox2_db_name=None, phabox2_db_baselink=None, CHERRY_params=None, PhaTYP_params=None, iphop_host=False, iphop_cutoff=90, iphop_params=None, iphop_db=None, iphop_db_version=None, iphop_db_basename=None):
        self.hasOptions = hasOptions
        self.PhaBox2_db = PhaBox2_db
        self.phabox2_db_name = phabox2_db_name
        self.phabox2_db_baselink = phabox2_db_baselink
...
class ViralAnnotateModule(Module):
    ...
    name = "viral-annotate"
    def __init__(self, hasOptions=False, PhaBox2_db=None, eggNOG_db=None, eggNOG_db_params=None, eggNOG_params=None, PhaVIP_params=None, virsorter2_annotate_params=None, dram_v_annotate_params=None, dram_v_distill_params=None, dram_db=None, dram_setup_params=None, metacerberus_db=None, metacerberus_setup_params=None, metacerberus_params=None, pharokka_db=None, pharokka_params=None, phabox2_db_name=None, phabox2_db_baselink=None):
        self.hasOptions = hasOptions
        self.PhaBox2_db = PhaBox2_db
...
class ProkaryoticBinningModule(Module):
    ...
    name = "prok-binning"
    def __init__(self, hasOptions=False, checkm2_db=None, GTDBTk_db=None, GTDBTk_db_version=None, binning_consensus=True, strobealign_params=None, MetaBAT2_params=None, MaxBin2_params=None, CONCOCT_params=None, jgi_summarize_params=None, DASTool_params=None, checkm2_params=None, galah_params=None, GTDBTk_identify_params=None, GTDBTk_align_params=None, GTDBTk_classify_params=None, VAMB_params=None):
...
class ProkaryoticAnnotateModule(Module):
    ...
    name = "prok-annotate"
    def __init__(self, hasOptions=False, humann_params=None, humann-db=None):
        self.hasOptions = hasOptions
        self.humann_params = humann_params
        self.humann-db = humann-db
...
class SetupDatabaseModule(Module):
    ...
    name = "setup-database"
    def __init__(self, hasOptions=False, hostile_index_db=None, PhaBox2_db=None, genomad_db=None, virsorter2_db=None, vibrant_db=None, checkv_db=None, iphop_db=None, iphop_db_version=None, iphop_db_basename=None, eggNOG_db=None, eggNOG_db_params=None, humann_db=None, checkm2_db=None, GTDBTk_db=None, GTDBTk_db_version=None, dram_db=None, dram_setup_params=None, metacerberus_db=None, metacerberus_setup_params=None, pharokka_db=None, phabox2_db_name=None, phabox2_db_baselink=None):
        self.hasOptions = hasOptions
